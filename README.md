...
| **🧹 Người 2 – Data Cleaning Specialist** -Nguyễn Hữu Dương | - Tiền xử lý và làm sạch dữ liệu<br>- Xử lý missing values, duplicates, outliers<br>- Chuẩn hóa format dữ liệu | Jupyter Notebook, Pandas, NumPy    |
