...
| **🧹 Người 2 – Nguyễn Thanh Hải (Data Cleaning Specialist)**  | - Tiền xử lý và làm sạch dữ liệu<br>- Xử lý missing values, duplicates, outliers<br>- Chuẩn hóa format dữ liệu | Jupyter Notebook, Pandas, NumPy    |
